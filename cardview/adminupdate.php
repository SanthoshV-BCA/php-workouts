...
<body>
    ...
    if (isset($_POST["update"])) {
        ...
        // }
        $sql = "UPDATE `card` SET `Name`='$name',`Email`='$email',`password`='$password', `del`='$delete' WHERE `id`='$id'";
        $result = $conn->query($sql);
        if ($result) {
    ...
    <div class="container">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
            ...
            <div class="form-group">
                <label> status: </label>
                <input type="text" name="delete" placeholder="Enter user status" value="<?= $updatedel; ?>"><br>
